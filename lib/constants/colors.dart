...
class StockAppColors {
  ...
  static const greyLight = Color(0xffE1E1E1);
  static const textLightkGrey = Color(0xffAAAAAA);
  static const textGrey = Color(0xff7E7E7E);
  static const divderDark = Color(0xff1f1f1f);
  static const blackBg = Color(0xff1A1A1A);
